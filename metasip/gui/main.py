...
from .tools import (ApiEditorTool, FeaturesTool, ModulesTool, PlatformsTool,
        VersionsTool)
#from .tools import ImportProjectTool, LoggerTool, ScannerTool
...
def main():
    ...
    # Create the shell.
    shell = Shell(ApiEditorTool, FeaturesTool, ModulesTool, PlatformsTool,
            VersionsTool)
