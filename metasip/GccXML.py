...
class _Struct(_ScopedItem, _Access):
    ...
    def __init__(self, parser, attrs):
        ...
        self.incomplete = int(optAttribute(attrs, "incomplete", "0"))
...
class _Constructor(_ClassCallable):
    ...
    def __init__(self, parser, attrs):
        ...
        self.explicit = int(optAttribute(attrs, "explicit", "0"))
...
class _Destructor(_ScopedItem, _Access):
    ...
    def __init__(self, parser, attrs):
        ...
        self.virtual = int(optAttribute(attrs, "virtual", "0"))
...
class _Converter(_ClassCallable):
    ...
    def __init__(self, parser, attrs):
        ...
        self.const = int(optAttribute(attrs, "const", "0"))
...
class _Method(_ClassCallable):
    ...
    def __init__(self, parser, attrs):
        ...
        self.virtual = int(optAttribute(attrs, "virtual", "0"))
        self.const = int(optAttribute(attrs, "const", "0"))
        self.static = int(optAttribute(attrs, "static", "0"))
        self.abstract = int(optAttribute(attrs, "pure_virtual", "0"))
...
class GccXMLParser(ParserBase):
    ...
    def variableStart(self, attrs):
        ...
        if optAttribute(attrs, "artificial") is not None:
            return
