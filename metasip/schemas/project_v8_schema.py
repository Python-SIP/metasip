...
class ProjectV8Schema(Model):
    """ The ProjectV8Schema class validates an XML file against the project v8
    schema.
    """

    # The filter.
    filter = "MetaSIP project v8 files (*.msp)"

    # The name to be displayed to the user.
    name = "MetaSIP project v8"

    # The name of the schema file relative to this file.
    schema_file = 'project_v8.xsd'
