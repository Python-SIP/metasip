...
class ProjectV14Schema(Model):
    """ The ProjectV14Schema class validates an XML file against the project
    v14 schema.
    """

    # The filter.
    filter = "MetaSIP project v14 files (*.msp)"

    # The name to be displayed to the user.
    name = "MetaSIP project v14"

    # The name of the schema file relative to this file.
    schema_file = 'project_v14.xsd'
