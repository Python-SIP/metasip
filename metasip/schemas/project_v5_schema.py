...
class ProjectV5Schema(Model):
    """ The ProjectV5Schema class validates an XML file against the project v5
    schema.
    """

    # The filter.
    filter = "MetaSIP project v5 files (*.msp)"

    # The name to be displayed to the user.
    name = "MetaSIP project v5"

    # The name of the schema file relative to this file.
    schema_file = 'project_v5.xsd'
