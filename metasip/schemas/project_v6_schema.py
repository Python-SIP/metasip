...
class ProjectV6Schema(Model):
    """ The ProjectV6Schema class validates an XML file against the project v6
    schema.
    """

    # The filter.
    filter = "MetaSIP project v6 files (*.msp)"

    # The name to be displayed to the user.
    name = "MetaSIP project v6"

    # The name of the schema file relative to this file.
    schema_file = 'project_v6.xsd'
