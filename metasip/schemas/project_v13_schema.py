...
class ProjectV13Schema(Model):
    """ The ProjectV13Schema class validates an XML file against the project
    v13 schema.
    """

    # The filter.
    filter = "MetaSIP project v13 files (*.msp)"

    # The name to be displayed to the user.
    name = "MetaSIP project v13"

    # The name of the schema file relative to this file.
    schema_file = 'project_v13.xsd'
