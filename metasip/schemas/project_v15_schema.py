...
class ProjectV15Schema(Model):
    """ The ProjectV15Schema class validates an XML file against the project
    v15 schema.
    """

    # The filter.
    filter = "MetaSIP project v15 files (*.msp)"

    # The name to be displayed to the user.
    name = "MetaSIP project v15"

    # The name of the schema file relative to this file.
    schema_file = 'project_v15.xsd'
