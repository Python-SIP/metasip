...
class ProjectV11Schema(Model):
    """ The ProjectV11Schema class validates an XML file against the project
    v11 schema.
    """

    # The filter.
    filter = "MetaSIP project v11 files (*.msp)"

    # The name to be displayed to the user.
    name = "MetaSIP project v11"

    # The name of the schema file relative to this file.
    schema_file = 'project_v11.xsd'
