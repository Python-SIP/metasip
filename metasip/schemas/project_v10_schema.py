...
class ProjectV10Schema(Model):
    """ The ProjectV10Schema class validates an XML file against the project
    v10 schema.
    """

    # The filter.
    filter = "MetaSIP project v10 files (*.msp)"

    # The name to be displayed to the user.
    name = "MetaSIP project v10"

    # The name of the schema file relative to this file.
    schema_file = 'project_v10.xsd'
