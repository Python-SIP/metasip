...
class ProjectV4Schema(Model):
    """ The ProjectV4Schema class validates an XML file against the project v4
    schema.
    """

    # The filter.
    filter = "MetaSIP project v4 files (*.msp)"

    # The name to be displayed to the user.
    name = "MetaSIP project v4"

    # The name of the schema file relative to this file.
    schema_file = 'project_v4.xsd'
