...
class ProjectV9Schema(Model):
    """ The ProjectV9Schema class validates an XML file against the project v9
    schema.
    """

    # The filter.
    filter = "MetaSIP project v9 files (*.msp)"

    # The name to be displayed to the user.
    name = "MetaSIP project v9"

    # The name of the schema file relative to this file.
    schema_file = 'project_v9.xsd'
