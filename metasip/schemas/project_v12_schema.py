...
class ProjectV12Schema(Model):
    """ The ProjectV12Schema class validates an XML file against the project
    v12 schema.
    """

    # The filter.
    filter = "MetaSIP project v12 files (*.msp)"

    # The name to be displayed to the user.
    name = "MetaSIP project v12"

    # The name of the schema file relative to this file.
    schema_file = 'project_v12.xsd'
