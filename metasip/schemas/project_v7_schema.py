...
class ProjectV7Schema(Model):
    """ The ProjectV7Schema class validates an XML file against the project v7
    schema.
    """

    # The filter.
    filter = "MetaSIP project v7 files (*.msp)"

    # The name to be displayed to the user.
    name = "MetaSIP project v7"

    # The name of the schema file relative to this file.
    schema_file = 'project_v7.xsd'
