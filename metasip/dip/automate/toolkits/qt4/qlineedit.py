...
@adapt(QLineEdit, to=IAutomatedEditor)
class QLineEditIAutomatedEditorAdapter(Adapter):
    ...
    def simulate_set(self, id, delay, value):
        ...
        if value:
            QTest.keyClicks(widget, value, Qt.NoModifier, delay)
        else:
            QTest.keyClick(widget, Qt.Key_Backspace, Qt.NoModifier, delay)
