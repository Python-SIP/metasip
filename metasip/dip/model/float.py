...
class Float(ValueTypeFactory):
    """ The Float class encapsulates a Python float. """

    def __init__(self, default=0.0, allow_none=False, allow_rebind=True, getter=None, setter=None, **metadata):
    ...
    def validate(self, value):
        ...
        if not isinstance(value, float):
            try:
                ...
                raise ValidationTypeError(type(self), float, value)
