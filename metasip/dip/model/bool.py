...
class Bool(ValueTypeFactory):
    """ The Bool class encapsulates a Python bool. """

    def __init__(self, default=False, allow_none=False, allow_rebind=True, getter=None, setter=None, **metadata):
    ...
    def validate(self, value):
        ...
        if not isinstance(value, bool):
            # See if it supports the bool protocol so that we avoid Python's
            # liberal bool convertions.
            if not hasattr(value, '__bool__'):
                raise ValidationTypeError(type(self), bool, value)
