...
class Qt6ToolkitError(ToolkitError):
    """ The Qt6ToolkitError class is an exception raised when there is an error
    related to the Qt6 toolkit.
    """
...
class Qt6ToplevelWidgetError(Qt6ToolkitError):
    """ The Qt6ToplevelWidgetError class is an exception raised when attempting
