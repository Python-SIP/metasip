...
from PyQt4.QtGui import (QAction, QApplication, QCheckBox, QComboBox, QDialog,
        QDialogButtonBox, QDockWidget, QDoubleSpinBox, QFileDialog,
        QFormLayout, QGridLayout, QGroupBox, QHBoxLayout, QKeySequence, QLabel,
        QLayout, QLineEdit, QListView, QMainWindow, QMessageBox, QMenu,
        QMenuBar, QPushButton, QSpinBox, QSplitter, QStyle, QTabWidget,
        QTextEdit, QToolButton, QTreeView, QVBoxLayout, QWhatsThis, QWidget,
        QWizard, QWizardPage)

from ...toolkits import AbstractUIToolkit

from .exceptions import Qt4ToplevelWidgetError
...
class Toolkit(AbstractUIToolkit):
    ...
    def dialog(self, parent, top_level):
        ...
        if not top_level:
            raise Qt4ToplevelWidgetError('QDialog')
    ...
    def wizard(self, parent, top_level):
        ...
        if not top_level:
            raise Qt4ToplevelWidgetError('QWizard')
