...
from PyQt4.QtGui import QDialog, QDialogButtonBox, QLayout

from .....model import adapt, Instance, unadapted
from .....ui import IDialog, IView

from ..exceptions import Qt4ToolkitError
...
class QDialogIDialogAdapter(SingleViewContainerWidgetAdapter):
    ...
    def _button_box(self):
        ...
        if button_box is None:
            raise Qt4ToolkitError("{0} instance implementing a Dialog does "
