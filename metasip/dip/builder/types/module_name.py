...
class ModuleName(Str):
    """ The ModuleName class is a string for holding the name of a Python
    module.
    """
    ...
    def __init__(self, default='', **metadata):
        ...
        metadata.setdefault('tool_tip', "The name of the Python module")
        metadata.setdefault('whats_this',
                "This is the name of the Python module.")
