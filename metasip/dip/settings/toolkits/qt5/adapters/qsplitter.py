...
@adapt(QSplitter, to=ISettings)
class QSplitterISettingsAdapter(WidgetAdapter):
    """ An adapter to implement ISettings for a QSplitter. """
    ...
    def save(self, settings_manager):
        ...
        settings_manager.write_value('state', self.adaptee.saveState())
