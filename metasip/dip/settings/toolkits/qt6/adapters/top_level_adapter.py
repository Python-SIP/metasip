...
class TopLevelAdapter(WidgetAdapter):
    """ A base adapter for all top-level widgets. """
    ...
    def restore(self, settings_manager):
        ...
        value = settings_manager.read_value('geom')
        if value is not None:
            self.adaptee.restoreGeometry(value)
    ...
    def save(self, settings_manager):
        ...
        settings_manager.write_value('geom', self.adaptee.saveGeometry())
