...
@adapt(QHeaderView, to=ISettings)
class QHeaderViewISettingsAdapter(WidgetAdapter):
    """ An adapter to implement ISettings for a QHeaderView. """
    ...
    def restore(self, settings_manager):
        ...
        if value is not None:
            self.adaptee.restoreState(value)
    ...
    def save(self, settings_manager):
        ...
        settings_manager.write_value('header', self.adaptee.saveState())
