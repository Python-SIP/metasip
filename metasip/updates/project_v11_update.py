...
@implements(IUpdate)
class ProjectV11Update(Model):
    """ The ProjectV11Update class implements the update of a project from v10
    to v11.
    """
    ...
    def update(self, root, view):
        ...
        # The v11 schema adds uselimitedapi to module so we just need to bump
        # the version number.
