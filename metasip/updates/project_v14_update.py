...
@implements(IUpdate)
class ProjectV14Update(Model):
    """ The ProjectV14Update class implements the update of a project from v13
    to v14.
    """
    ...
    def update(self, root, view):
        ...
        # The v14 format adds the /ScopesStripped/ argument annotation so we
