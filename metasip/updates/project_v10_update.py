...
@implements(IUpdate)
class ProjectV10Update(Model):
    """ The ProjectV10Update class implements the update of a project from v9
    to v10.
    """
    ...
    def update(self, root, view):
        ...
        # The v10 schema adds pydefault to arguments so we just need to bump
        # the version number.
