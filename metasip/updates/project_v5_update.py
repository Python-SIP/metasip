...
@implements(IUpdate)
class ProjectV5Update(Model):
    """ The ProjectV5Update class implements the update of a project from v4 to
    v5.
    """
    ...
    def update(self, root, view):
        ...
        # The v5 schema adds %FinalisationCode to classes so we just need to
